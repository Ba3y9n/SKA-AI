  ...
  const achievements: Achievement[] = [
    {
      ...
      year: "2024",
      details: "منافسة قوية شملت 40 فريقاً يمثلون 18 جامعة على مستوى المملكة، حيث تم تقديم حلول محاسبية مبتكرة.",
      source: "https://qu.edu.sa/"
    },
    {
      id: "2",
      names: "رندا، أمل، شهد، بشرى، ليان",
      title: "مشروع رواء",
      event: "معرض مبدعون",
      year: "2024",
      details: "مشروع طلابي مرتبط بالتقنية والاستدامة، تأهل ضمن 44 مشروعاً للمرحلة النهائية من أصل 143+ مشروعاً مشاركاً.",
      source: "https://cbe.qu.edu.sa/"
    },
    {
      id: "3",
      names: "مسرى، رند، هياء، أفراح، ليان",
      title: "مشروع منيع",
      event: "معرض مبدعون",
      year: "2024",
      details: "مشاركة فعالة ومتميزة في معرض مبدعون للأعمال الطلابية الابتكارية، والذي شهد مشاركة أكثر من 143 مشروعاً.",
      source: "https://cbe.qu.edu.sa/"
    },
    {
      id: "4",
      names: "د. بشاير البليهي",
      title: "أصوات نسائية تصنع الأثر",
      event: "تمكين وابتكار",
      year: "2024",
      details: "مشاركات تحكيمية متقدمة، وأدوار أكاديمية رائدة في الابتكار والمبادرات المجتمعية للتمكين الاقتصادي.",
      source: "https://cbe.qu.edu.sa/"
    }
  ];

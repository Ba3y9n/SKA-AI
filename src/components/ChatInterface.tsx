...
export const ChatInterface: React.FC<ChatInterfaceProps> = ({
  ...
  // Auto-scroll ONLY within the chat box (NEVER scrolling the browser window)
  useEffect(() => {
  ...
  return (
    <div className="flex flex-col h-[520px] sm:h-[580px] w-full rounded-2xl bg-[#09140e]/90 border border-emerald-900/50 backdrop-blur-md shadow-2xl overflow-hidden">
      ...
      {/* Audio Notice Banner if audio failed but text is preserved */}
      {audioNotice && (
        <div className="bg-amber-950/60 border-b border-amber-800/40 px-4 py-2 flex items-center justify-between text-xs text-amber-200">
                  ...
                  <div className="flex items-center gap-1.5 opacity-0 group-hover:opacity-100 transition-opacity">
                    {!isUser && (
                      <button
                        ...
                        className="p-1 hover:text-emerald-300 rounded transition flex items-center gap-1"
        ...
        {characterState === 'THINKING' && (
          <div className="flex items-center gap-2.5 flex-row">
            ...
            <div className="rounded-2xl px-4 py-3 bg-emerald-950/60 border border-emerald-800/40 flex items-center gap-1.5">
              <span className="text-xs text-emerald-300 font-medium ml-1">رِواء تفكر وتستحضر الرد</span>
        ...
        <div className="relative flex-1">
          <input
            ...
            placeholder={
              isListening
                ? 'جاري الاستماع لصوتك...'
                : 'اسأل رِواء عن اليوم الوطني، مناطق المملكة، أو المستقبل...'
            }
